...
TICKER_ALIASES = {
    ...
    "BBNI": ["bbni", "bni", "bank negara indonesia", "bank negara"],
    "BBTN": ["bbtn", "btn", "bank tabungan negara"],
    "BRIS": ["bris", "bsi", "bank syariah indonesia", "bank syariah"],
    ...
    "MDKA": ["mdka", "merdeka copper gold", "merdeka copper"],
    ...
    "INDF": ["indf", "indofood sukses makmur", "indofood"],
